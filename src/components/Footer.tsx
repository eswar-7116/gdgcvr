        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-8">
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                { icon: Linkedin, label: "LinkedIn", href: "https://www.linkedin.com/company/gdsc-cvr/", color: "text-[#0077b5]" },
                { icon: Github, label: "GitHub", href: "https://www.github.com/gdgcvr/", color: "text-[#333]" },
                { icon: Instagram, label: "Instagram", href: "https://www.instagram.com/gdgccvr/", color: "text-[#E1306C]" },
                {
                  icon: () => (
                    <img
                ...
                >
                  ...
                  >
                    <Icon size={16} className={`text-foreground/80 group-hover:opacity-100 transition-colors ${color ? `group-hover:${color}` : ''}`} />
                  </motion.div>
